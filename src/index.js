...
document
  .querySelector(".close-task-modal")
...
document
  .querySelector(".close-block-modal")
  .addEventListener("click", function () {
    const blockModal = document.querySelector(".block-modal");
    blockModal.classList.toggle("hidden");
  });
...
document
  ...
  .addEventListener("click", function changeCurrentBlockToSelectedItem(e) {
...
document
  .querySelector("#blocks-list")
  .addEventListener("click", function removeItemFromList(e) {
...
document
  ...
  .addEventListener("click", function removeTask(e) {
...
document
  .querySelector(".main-grid")
  .addEventListener("click", function toggleCompleteTask(e) {
...
document
  .querySelector(".main-grid")
  .addEventListener("click", function showTaskEditForm(e) {
    if (e.target.classList.contains("edit-task-btn")) {
      const currentTask = TimeBlockController.getCurrentTask(
      ...
      document.querySelector("#edit-task-title").textContent =
        currentTask.title;
      document.querySelector("#edit-task-description").textContent =
...
document
  .querySelector(".task-edit-submit")
  .addEventListener("click", function submitTaskEditForm() {
    const taskModal = document.querySelector(".edit-task-modal");
...
document
  ...
  .addEventListener("click", function closeTaskEditForm() {
    const taskModal = document.querySelector(".edit-task-modal");
    taskModal.classList.toggle("hidden");
  });
...
document
  .querySelector("#blocks-list")
  .addEventListener("click", function showBlockEditFormById(e) {
    if (e.target.classList.contains("edit-item-btn")) {
      const blockModal = document.querySelector(".block-edit-modal");
      var selectedBlock = TimeBlockController.getBlock(
        e.target.getAttribute("value")
      );

      document.querySelector("#block-date-edit").value = selectedBlock.date;
      document.querySelector("#wake-time-edit").options[
        selectedBlock.wakeTime
      ].selected = true;
      document.querySelector("#sleep-time-edit").options[
        selectedBlock.sleepTime
      ].selected = true;
...
document
  .querySelector(".block-edit-submit")
  .addEventListener("click", function editSelectedBlock() {
    const blockModal = document.querySelector(".block-edit-modal");
...
document
  .querySelector(".close-block-edit-modal")
  .addEventListener("click", function closeblockEditForm() {
    const blockModal = document.querySelector(".block-edit-modal");
    blockModal.classList.toggle("hidden");
  });
